...
f.close()
#Reading the processed tweet .csv file after preprocessing
...
def call_demo(batch_size,num_epochs,num_filters,lrate,particle_rep):
    ...
    for train_index, test_index in kf.split(word_seq_train, y_train):
        ...
        callbacks_list = [csv_logger]#, tensor_board]#, early_stop,check_pts]
...
No_of_points = 8   #swarm size 
binary_max = 8      #maximum bits 
O_Points = []
